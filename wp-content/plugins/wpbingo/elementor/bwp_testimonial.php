...
class Bwp_Testimonial extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'show_thumbnail',
			[
				'label' => __( 'Show Image Testimonial', 'wpbingo' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'1'  => __( 'Yes', 'wpbingo' ),
					'0' => __( 'No', 'wpbingo' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwp-testimonial .testimonial-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bwp-testimonial .testimonial-title',
				'global' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwp-testimonial .testimonial-title' => 'font-family: {{VALUE}};',
				],
				'condition'   => [
                    'font_custom_title!' => '',
                ]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwp-testimonial .testimonial-title' => 'margin-bottom: {{SIZE}}{{UNIT}};margin-top:0;',
				],
			]
		);
		$this->add_responsive_control(
			'align_title',
			[
				'label' => __( 'Alignment Title', 'wpbingo' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'wpbingo' ),
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}}  .bwp-testimonial .testimonial-title' => 'text-align: {{VALUE}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwp-testimonial .testimonial-content .item' => 'max-width: {{SIZE}}{{UNIT}}; margin:auto;',
				],
			]
		);
		$this->add_control(
