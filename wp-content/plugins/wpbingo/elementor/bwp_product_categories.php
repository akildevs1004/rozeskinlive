...
class Bwp_Product_Categories extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => '0',
				'condition'   => [
                    'layout' => ["default","slider","hover-reveal"],
                ]
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories' => 'text-align: {{VALUE}};',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'hover-reveal' 			=> __( 'Image Reveal', 'wpbingo' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .bwp-categories-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bwp-woo-categories .bwp-categories-title',
				'global' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .bwp-categories-title' => 'margin-bottom: {{SIZE}}{{UNIT}};margin-top:0;',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .item-name a' => 'color: {{VALUE}};',
				],
				'separator' => 'after',
			]
		);
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories.hover-reveal .content-reveal .link:before' => 'background: {{VALUE}};',
				],
				'global' => [
		...
		$this->add_group_control(
			...
			[
				...
				'exclude' => [ 'image' ],
				'selector' => '{{WRAPPER}} .bwp-woo-categories .item-name a',
				'fields_options' => [
					'background' => [
						'default' => 'classic',
					],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .info:hover .item-name a' => 'color: {{VALUE}};',
				],
				'separator' => 'after',
			]
		);
		$this->add_control(
			'border_color_hover',
			[
				'label' => __( 'Border Color Hover', 'wpbingo' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories.hover-reveal .content-reveal:hover .link:before' => 'background: {{VALUE}};',
				],
				'global' => [
					'default' => Global_Colors::COLOR_TEXT,
				],
		...
		$this->add_group_control(
			Group_Control_Background::get_type(),
			[
				'name' => 'name_background_hover',
				'label' => __( 'Background', 'wpbingo' ),
				'types' => [ 'classic', 'gradient' ],
				'exclude' => [ 'image' ],
				'selector' => '{{WRAPPER}} .bwp-woo-categories .info:hover .item-name a, {{WRAPPER}} .bwp-woo-categories .item-name a:focus',
				'fields_options' => [
					'background' => [
						'default' => 'classic',
					],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bwp-woo-categories .item-name',
				'global' => [
					'default' => Global_Typography::TYPOGRAPHY_PRIMARY,
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .item-name' => 'font-family: {{VALUE}};',
				],
				'condition'   => [
                    'font_custom_title!' => '',
                ]
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .item-name' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .item-name a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .item-name a' => 'min-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_tabs( 'tabs_count_hover');
		$this->start_controls_tab(
			'tab_count_normal',
			[
				'label' => __( 'Normal', 'wpbingo' ),
		...
		$this->add_control(
			'count_color_hover',
			[
				'label' => __( 'Count Color Hover', 'wpbingo' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'global' => [
					'default' => Global_Colors::COLOR_PRIMARY,
				],
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories .info:hover .item-count' => 'color: {{VALUE}};',
				],
				'separator' => 'after',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories.slider .item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .bwp-woo-categories.slider .slick-list' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
	...
	protected function render() {
		...
		}elseif($layout == 'hover-reveal'){
			include( WPBINGO_ELEMENTOR_TEMPLATE_PATH.'bwp-product-categories/image-reveal.php' );
