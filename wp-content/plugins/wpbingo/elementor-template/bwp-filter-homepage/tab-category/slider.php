...
if( $category ){ 	
	...
	$numberposts = (int)$numberposts;
?>
<div class="bwp-filter-homepage tab-category slider <?php if(!empty($show_slick_mobile)) echo 'bwp_slick-margin-mobile'; ?> <?php echo esc_attr($layout);?>" <?php if($style_product > 1) { ?>data-content_product="<?php echo esc_attr($style_product) ?>"<?php } ?> data-numberposts = "<?php echo esc_attr($numberposts); ?>" >
