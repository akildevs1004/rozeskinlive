...
class Plugin {
	...
	public function register_widgets() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register( new Widgets\Bwp_Button() );
		\Elementor\Plugin::instance()->widgets_manager->register( new Widgets\Bwp_Icon_Box() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register( new Widgets\Bwp_Product_Template() );
	}
