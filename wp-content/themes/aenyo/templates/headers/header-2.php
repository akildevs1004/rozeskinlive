...
if (get_theme_mod('header_order_2')) {
	...
	$header_order_2   = 'logo-menu-icons';
	$arr_header_order =  explode("-", "logo-menu-icons");
}
?>
<h42 class="bwp-title hide"><a href="<?php echo esc_url(home_url('/')); ?>" rel="home"><?php bloginfo('name'); ?></a></h42>
<header id='bwp-header' class="bwp-header header-v2">
	...
	<div class="header-desktop">
		<div class='header-wrapper' data-sticky_header="<?php echo esc_attr($aenyo_settings['enable-sticky-header']); ?>">
			<div class="container">
				<div class="header-container <?php echo esc_attr($header_order_2) ?> <?php echo get_theme_mod('menu_pos_2', 'menu-center'); ?>">
					<?php foreach ($arr_header_order as $value) {
						switch ($value) {
							...
							<?php break;
							case 'menu': ?>
								<div class="header-menu <?php echo get_theme_mod('menu_pos_2', 'menu-center'); ?>">
							...
							case 'icons': ?>
								<?php if (($show_account || $show_minicart || $show_wishlist || is_active_sidebar('top-link')) && class_exists('WooCommerce')) { ?>
									<div class="header-icon <?php echo get_theme_mod('icon_pos_2', 'text-right'); ?>">
										<div class="header-page-link <?php echo get_theme_mod('icon_pos_2', 'text-right'); ?>">
											<!-- Begin Search -->
