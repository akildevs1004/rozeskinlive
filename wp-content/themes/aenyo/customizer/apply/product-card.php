<?php if(get_theme_mod('color_button_1', '')) { ?>
	...
	.products-list.grid .content-product1 .products-thumb .product-button .product_type_variable:before{ 
		color: <?php echo get_theme_mod('color_button_1', ''); ?>; 
	}
	...
	.products-list.grid .content-product1 .products-thumb .product-button .woosw-added:before{
		color: <?php echo get_theme_mod('color_button_1', ''); ?>; 
	}
<?php } ?>
<?php if(get_theme_mod('background_button_1', '')) { ?>
	...
	.products-list.grid .content-product1 .products-thumb .product-button .product_type_variable{
		background: <?php echo get_theme_mod('background_button_1', ''); ?>;
	}
	.products-list.grid .content-product1 .products-thumb .product-button .woosw-btn{
		background: <?php echo get_theme_mod('background_button_1', ''); ?>;
	}
	.products-list.grid .content-product1 .products-thumb .product-button .product-quickview{
		background: <?php echo get_theme_mod('background_button_1', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('color_title_1', '')) { ?>
	.products-list.grid .content-product1 .products-content h3.product-title a{
		color: <?php echo get_theme_mod('color_title_1', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('size_title_1', '')) { ?>
	.products-list.grid .content-product1 .products-content h3.product-title{
		font-size: <?php echo get_theme_mod('size_title_1', ''); ?>px;
	}
<?php } ?>
<?php if(get_theme_mod('color_price_1', '')) { ?>
	.products-list.grid .content-product1 .products-content .price{
		color: <?php echo get_theme_mod('color_price_1', ''); ?>;
	}
	.products-list.grid .content-product1 .products-content .price ins{
		color: <?php echo get_theme_mod('color_price_1', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('color_price_sale_1', '')) { ?>
	.products-list.grid .content-product1 .products-content .price del{
		color: <?php echo get_theme_mod('color_price_sale_1', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('size_price_1', '')) { ?>
	.products-list.grid .content-product1 .products-content .price{
		font-size: <?php echo get_theme_mod('size_price_1', ''); ?>px;
	}
	.products-list.grid .content-product1 .products-content .price ins{
		font-size: <?php echo get_theme_mod('size_price_1', ''); ?>px;
	}
	.products-list.grid .content-product1 .products-content .price del{
		font-size: calc(<?php echo get_theme_mod('size_price_1', ''); ?>px - 2px);
	}
<?php } ?>
<?php if(get_theme_mod('color_sale_1', '')) { ?>
	.products-list.grid .content-product1 .product-lable .onsale{
		color: <?php echo get_theme_mod('color_sale_1', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('background_sale_1', '')) { ?>
	.products-list.grid .content-product1 .product-lable .onsale{
		background: <?php echo get_theme_mod('background_sale_1', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('color_hot_1', '')) { ?>
	.products-list.grid .content-product1 .product-lable .hot{
		color: <?php echo get_theme_mod('color_hot_1', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('background_hot_1', '')) { ?>
	.products-list.grid .content-product1 .product-lable .hot{
		background: <?php echo get_theme_mod('background_hot_1', ''); ?>;
	}
<?php } ?>
...
<?php if(get_theme_mod('color_button_3', '')) { ?>
	.products-list.grid .content-product3 .products-thumb .product-button .add_to_cart_button:before{
...
<?php if(get_theme_mod('background_button_3', '')) { ?>
	.products-list.grid .content-product3 .products-thumb .product-button .add_to_cart_button{
	...
	.products-list.grid .content-product3 .products-thumb .product-button .product-quickview{
		background: <?php echo get_theme_mod('background_button_3', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('color_whishlist_3', '')) { ?>
	.products-list.grid .product-wapper.content-product3 .products-content .woosw-btn:before{
		color: <?php echo get_theme_mod('color_whishlist_3', ''); ?>;
	}
<?php } ?>
...
<?php if(get_theme_mod('background_button_4', '')) { ?>
	...
	.products-list.grid .content-product4 .products-thumb .product-button .product-quickview{
		background: <?php echo get_theme_mod('background_button_4', ''); ?>; 
	}
<?php } ?>
<?php if(get_theme_mod('color_atc_button_4', '')) { ?>
	.products-list.grid .product-wapper .products-thumb .btn-atc > div > a{
		color: <?php echo get_theme_mod('color_atc_button_4', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('background_atc_button_4', '')) { ?>
	.products-list.grid .product-wapper .products-thumb .btn-atc > div > a{
		background: <?php echo get_theme_mod('background_atc_button_4', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('color_title_4', '')) { ?>
	.products-list.grid .content-product4 .products-content h4.product-title a{
		color: <?php echo get_theme_mod('color_title_4', ''); ?>;
	}
<?php } ?>
<?php if(get_theme_mod('size_title_4', '')) { ?>
	.products-list.grid .content-product4 .products-content h4.product-title{
...
<?php if(get_theme_mod('background_attr_5', '')) { ?>
	.products-list.grid .product-wapper.content-product5 .content-form-attribute .form-attribute{
		background: <?php echo get_theme_mod('background_attr_5', ''); ?>5F;
	}
