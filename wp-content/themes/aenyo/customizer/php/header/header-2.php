<?php ///////////////HEADER 4
					...
					<div class="bwp-drag-dropdown_content">
						...
						<div class="bwp-drag-drop-content bwp-drag-drop-toggle" data-value="topbar3">
							<div class="drag-option">
								...
								<input style="margin-top:10px;" type="text" value="<?php echo esc_attr($this->value('phone_topbar_2')); ?>" <?php $this->link('phone_topbar_2'); ?>>
							</div>
							<div class="drag-option">
								<span class="customize-control-title"><?php echo esc_html__('Email','aenyo'); ?></span>
								<input style="margin-top:10px;" type="text" value="<?php echo esc_attr($this->value('email_topbar_2')); ?>" <?php $this->link('email_topbar_2'); ?>>
							</div>
							<div class="btn-delete-drop-content"><button class="delete-drop-content"><?php echo esc_html__('Delete','aenyo'); ?></button></div>
						</div>
					</div>
	...
	$wp_customize->add_setting( 'phone_topbar_2' , array(
		'default' => '0987653321',
		'sanitize_callback' => 'sanitize_html',
		'transport' => 'refresh',
	));
	$wp_customize->add_setting( 'email_topbar_2' , array(
	...
	$wp_customize->add_control( new Topbar_order_2( $wp_customize, 'topbar_order_2', array(
		...
		'settings' => [
			...
			'phone_topbar_2' => 'phone_topbar_2',
			'email_topbar_2' => 'email_topbar_2',
		],
	)));
	...
	//---- color icon
	$wp_customize->add_setting( 'color_icon_top_bar_2' , array(
		'default' => '',
		'sanitize_callback' => 'sanitize_color',
		'transport' => 'postMessage',
	));
	$wp_customize->add_control('color_icon_top_bar_2', array(
					...
					<div class="bwp-drag-dropdown_content">
						...
						<div class="bwp-drag-drop-content bwp-drag-drop-toggle" data-value="icons">
							...
							<div class="drag-option">
								...
								<select class="bwp-select" <?php $this->link('icon_pos_2'); ?>>
									<option value="text-left"><?php echo esc_html__('Left','aenyo'); ?></option>
									<option value="text-right"><?php echo esc_html__('Right','aenyo'); ?></option>
									<option value="text-center"><?php echo esc_html__('Center','aenyo'); ?></option>
								</select>
	...
	$wp_customize->add_setting( 'icon_pos_2' , array(
		'default' => 'text-right',
		'sanitize_callback' => 'sanitize_input',
		'transport' => 'postMessage' 
	));
