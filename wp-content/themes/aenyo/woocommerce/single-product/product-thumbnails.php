...
$columns = 	5; //aenyo_image_single_product()->product_count_thumb;
...
?>
	<div class="content-thumbnail-scroll<?php if ($total <= $columns) { ?> max-thumbnail<?php } ?>">
		<div class="image-thumbnail slick-carousel" data-asnavfor=".image-additional" data-focusonselect="true" data-columns4="4" data-columns3="<?php echo esc_attr($columns); ?>" data-columns2="<?php echo esc_attr($columns); ?>" data-columns1="<?php echo esc_attr($columns); ?>" data-columns="<?php echo esc_attr($columns); ?>" data-nav="false" <?php echo esc_attr(aenyo_image_single_product()->class_data_image); ?>>
			<?php
