...
$class = "";
if(aenyo_image_single_product()->show_thumb && (aenyo_image_single_product()->position == "left" || aenyo_image_single_product()->position == "right"))
	$class = "vertical";
?>
<div class="images <?php echo esc_attr($class); ?>">
	<figure class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>">
		<div class="row">
			<?php if(aenyo_image_single_product()->show_thumb && aenyo_image_single_product()->position == "left") : ?>
				<div class="col-md-2">
					<?php
						/**
			...
			<div class="col-md-10">
				<div class="scroll-image">
					<div class="image-additional" <?php if(aenyo_image_single_product()->show_thumb == 'show') { ?> data-asnavfor=".image-thumbnail"<?php } ?> data-fade="true">
						<?php
						$attributes = array(
							'id'						=> "image", 	
							'title'                   => $image_title,
