...
$class = "";
if(aenyo_image_single_product()->show_thumb =='show' && (aenyo_image_single_product()->position == "left" || aenyo_image_single_product()->position == "right"))
	$class = "vertical";
?>
<div class="images <?php echo esc_attr($class); ?>">
	<figure class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>">
		<div class="row">
			<?php if(aenyo_image_single_product()->show_thumb =='show' && aenyo_image_single_product()->position == "left") : ?>
				<div class="<?php echo esc_attr(aenyo_image_single_product()->class_thumb); ?>">
					<?php do_action( 'woocommerce_product_thumbnails' ); ?>
				</div>
			<?php endif; ?>
			<div class="<?php echo esc_attr(aenyo_image_single_product()->class_image); ?>">
				<div class="scroll-image">
					<div class="image-additional slick-carousel" <?php if(aenyo_image_single_product()->show_thumb == 'show') { ?> data-asnavfor=".image-thumbnail"<?php } ?> data-fade="true" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1" data-nav="true">
						<?php
						$attributes = array(
							'id'						=> "image", 	
							'title'                   => $image_title,
			...
			<?php if(aenyo_image_single_product()->show_thumb && (aenyo_image_single_product()->position == "right" || aenyo_image_single_product()->position == "bottom")) : ?>
				<div class="<?php echo esc_attr(aenyo_image_single_product()->class_thumb); ?> content-thumbs-scroll">
				<?php do_action( 'woocommerce_product_thumbnails' ); ?>
				</div>
			<?php endif; ?>	
		</div>
