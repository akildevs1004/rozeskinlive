...
remove_action('woocommerce_after_shop_loop_item', 'aenyo_quickview', 15);
add_action('woocommerce_before_shop_loop_item_title', 'aenyo_quickview', 35);
	...
	<div class="row">
		...
		<div class="col-sm-8">
			<div class="products-content">
				...
				<?php aenyo_add_excerpt_in_product_archives(); ?>
			</div>
		</div>
	</div>
</div>